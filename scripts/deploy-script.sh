...
printf "\- Copy deploy-docker-compose.yml over to server\n"
rsync -rv --delete-after --progress -e "ssh -p 22022" $TRAVIS_BUILD_DIR/scripts/deploy-docker-compose.yml travis@$URI:~/$PROJECT_FOLDER/docker-compose.yml
